        ...
        <div className="container-fluid mt-3 pb-3 pt-3 bg-success">
            <div className="row justify-content-center">
                <div className="col-md-6 d-flex flex-md-row justify-content-evenly">
                    <ul className="list-unstyled d-flex flex-sm-rows">
                        <li className="">
                            <Link className="nav-link navlinks text-light" to={{pathname:link}} target="_blank" >
                                Home
                            </Link>
                        </li>
                        <li className="">
                            <Link className="nav-link navlinks text-light" to="">
                                Product
                            </Link>
                        </li>
                        <li className="">
